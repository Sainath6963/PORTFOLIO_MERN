...
export const getAllSkills = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      "https://mern-stack-portfolio-backend-jcei.onrender.com/api/v1/Skill/getAll",
      {
...
export const addNewSkill = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://mern-stack-portfolio-backend-jcei.onrender.com/api/v1/Skill/add",
      data,
      {
        withCredentials: true,
...
export const updateSkill = (id, proficiency) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.put(
      `https://mern-stack-portfolio-backend-jcei.onrender.com/api/v1/Skill/update/${id}`,
      { proficiency },
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://mern-stack-portfolio-backend-jcei.onrender.com/api/v1/Skill/delete/${id}`,
      {
        withCredentials: true,
      }
    );
