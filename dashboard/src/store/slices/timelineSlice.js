...
export const getAllTimeline = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      "https://new-backend-portfolio-railway.onrender.com/api/v1/timeline/getAll",
...
export const addNewTimeline = (timelineData) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      "https://new-backend-portfolio-railway.onrender.com/api/v1/timeline/add",
      timelineData,
      {
        withCredentials: true,
...
export const deleteTimeline = (id) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.delete(
      `https://new-backend-portfolio-railway.onrender.com/api/v1/timeline/deleteTimeline/${id}`,
      {
        withCredentials: true,
      }
    );
